...
//        Bank bank = new Bank();
//
//        new TransactionRequest(input);
//        bank.open(Arrays.stream(input.split(",")).map(new TransactionRequest()).collect(Collectors.toList()));
//
...
//            requests.parallelStream().forEach(this.request(null));
//        }
//
